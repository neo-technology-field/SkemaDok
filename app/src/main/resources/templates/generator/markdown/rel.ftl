...
> **Parameterised type.** Raw type names encode metadata in the suffix. Representative names: `${rel.instances[0..<shownCount]?join("`, `")}`<#if rel.instances?size gt 5> (+${rel.instances?size - 5} more)</#if>
